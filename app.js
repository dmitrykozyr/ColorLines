...
function resetInputs() {
    ConstantSourceNode.sliders = document.querySelectorAll('.sliders input');
    sliders.forEach(slider => {
        if(slider.name == 'hue') {
        ...
        if(slider.name == 'brightness') {
            const brighColor = initialColors[slider.getAttribute('data-bright')];
